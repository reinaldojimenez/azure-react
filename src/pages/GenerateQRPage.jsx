    ...
    <div className="flex h-[calc(100vh-100px)] items-center justify-center">
            <div className="bg-white p-5 rounded-2 text-secondary" style={{ width: 25 + 'rem', border: 1 + 'px solid #EE7A19' }}>
                ...
                <form onSubmit={onSubmit}>
                    <div className="mt-4">
                        <label className="w-full mb-2" style={{ fontWeight: 'bold' }} htmlFor="glosa"> Glosa: </label>          
                        <input className="w-full bg-zinc-50 border-solid border-2 border-orange-300 px-4 py-2 rounded-md my-2" type="text" name="glosa" id="glosa" placeholder="Glosa" { ...register("glosa", {required: true}) }/>
                        {
                            errors.glosa && (
                                <p className='text-red-500'> la glosa es requerida</p>
                            )
                        }
                    </div>
